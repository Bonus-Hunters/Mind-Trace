...
class TextSummarizer:
    ...
    def load_models(self) -> None:
        ...
        summarization_model = AutoModelForSeq2SeqLM.from_pretrained(self.summarization_model_name)
    ...
    def chunk_meeting_dialogue(
        ...
        for turn in meeting_json["dialogue"]:
            ...
            if self.count_tokens(current_text) >= self.max_tokens:
                ...
                overlap_text = self.tokenizer.decode(overlap_tokens_list, skip_special_tokens=True)
